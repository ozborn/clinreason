 ...
 * [cro.yml](cro.yml)
     * Determines how your purl.obolibrary.org/obo/cro/ redirects will be handled
     ...
     * Paste in the contents of [cro.yml](cro.yml)
 ...
 * [cro.md](cro.md)
     ...
     * Paste in the contents of [cro.md](cro.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
